...
Training_Dataset_Path = "C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataFullSplittedNew\\train"
Validation_Dataset_Path = "C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataFullSplittedNew\\val"
Testing_Dataset_Path = "C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataFullSplittedNew\\test"

#augmentation_Dataset_Path = "C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataSplitted\\aug"
...
#splitfolders.ratio('C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataFullNew', output='C:\\Users\\marce\\OneDrive\\Área de Trabalho\\DataFullSplittedNew', seed=1337, ratio=(.6, .20, .20), group_prefix=None, move=False)
...
if (Augment_Data == False):
    ...
    Training_Transform = transforms.Compose([
        ...
        #transforms.RandomGrayscale(p = 0.2), #Kept low due to color information(specifically green) being valuable during training
        transforms.ToTensor(),
...
Number_Classes = 3 #Defines the number of classes (categories of classification) used in the neural network. In this case, we have Healthy/Unhealthy so this variable is set to 2.
...
#showImagesFolder(augmentation_Dataset,1)
